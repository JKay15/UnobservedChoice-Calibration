...
class SyntheticSampler(BaseSampler):
    ...
    def __init__(self, cfg: ExpConfig):
        ...
        dist = torch.distributions.MultivariateNormal(
            mean_vector, covariance_matrix=cov_matrix
        )
    ...
    def sample(self) -> dict:
        ...
        sizes = np.random.randint(
            self.cfg.min_assortment_size, self.cfg.max_assortment_size + 1, size=N
        )
        ...
        return {"items": batch_items, "mask": batch_mask, "context": batch_context}
