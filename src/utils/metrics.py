...
def compute_p0_from_logits(
    z: torch.Tensor, s_hat: torch.Tensor, gamma: torch.Tensor
) -> torch.Tensor:
    """
...
def compute_nll(
    y_prob: torch.Tensor, y_true: torch.Tensor, epsilon: float = 1e-7
) -> float:
    """
...
def compute_nll_from_gamma(
    gamma: torch.Tensor, z: torch.Tensor, s: torch.Tensor, y_true: torch.Tensor
) -> float:
    """
